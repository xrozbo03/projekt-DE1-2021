...
entity top is
    ...
    (
     ...
     Tri_color_LED  : out STD_LOGIC_VECTOR(3 - 1 downto 0)-- Formerly in top preview it was mark as Tri-color_LED
    );
end top;

architecture Behavioral of top is

    signal s_diameter         : STD_LOGIC_VECTOR(5 - 1 downto 0);  -- name was missing in preview
    
    signal s_cycle            : STD_LOGIC;  -- name was missing in preview
    
    signal s_count            : STD_LOGIC;  -- name was missing in preview
...
--    signal s_trip_dig1        : STD_LOGIC_VECTOR(4 - 1 downto 0);   Distance is propably
--    signal s_trip_dig2        : STD_LOGIC_VECTOR(4 - 1 downto 0);   wrong, check it.
--    signal s_trip_dig3        : STD_LOGIC_VECTOR(4 - 1 downto 0);   Missing clk and reset
--    signal s_trip_dig4        : STD_LOGIC_VECTOR(4 - 1 downto 0);   instead of areset
...
--        port map
--        (
--            size_i                 =>  s_diameter, -- Missing clk input acording to picture ???
--            cycle_i                =>  s_cycle,
--            arst_i                 =>  reset,    -- Should be reset => reset ???
--            dis_trip_o             =>  s_distance,
--            dis_all_o              =>  ,         -- This isn´t in picture???

--            trip_dig1_o            =>  s_time_trip_dig1,
--            trip_dig2_o            =>  s_time_trip_dig2,
--            trip_dig3_o            =>  s_time_trip_dig3,
--            trip_dig4_o            =>  s_time_trip_dig4,
...
--        );
     ...
     speed_avg : entity work.speed_avg
        ...
        (
            ...
            distance_i             =>  s_distance, -- Not working due to distance is commented
     ...
     driver_7seg_4digits_mode : entity work.driver_7seg_4digits_mode
        ...
        (
            ...
            trip_dig1_i            =>  s_time_trip_dig1,
            trip_dig2_i            =>  s_time_trip_dig2,
            trip_dig3_i            =>  s_time_trip_dig3,
            trip_dig4_i            =>  s_time_trip_dig4,
            
            all_dig1_i             =>  s_all_dig1,  -- Not working due to distance is commented
            all_dig2_i             =>  s_all_dig2,  -- Not working due to distance is commented
            all_dig3_i             =>  s_all_dig3,  -- Not working due to distance is commented
            all_dig4_i             =>  s_all_dig4,  -- Not working due to distance is commented
