...
## Pmod Header JB
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { dig_o[3] }]; #IO_L11P_T1_SRCC_15 Sch=dig_o[0]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { dig_o[2] }]; #IO_L11N_T1_SRCC_15 Sch=dig_o[1]
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { dig_o[1] }]; #IO_L12P_T1_MRCC_15 Sch=dig_o[2]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { dig_o[0] }]; #IO_L12N_T1_MRCC_15 Sch=dig_o[3]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { dig_mode_o[3] }]; #IO_L23P_T3_FOE_B_15 Sch=dig_mode_o[0]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { dig_mode_o[2] }]; #IO_L23N_T3_FWE_B_15 Sch=dig_mode_o[1]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { dig_mode_o[1] }]; #IO_L24P_T3_RS1_15 Sch=dig_mode_o[2]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { dig_mode_o[0] }]; #IO_L24N_T3_RS0_15 Sch=dig_mode_o[3]

## Pmod Header JC
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { hall_sens_i }]; #IO_L20P_T3_A08_D24_14 Sch=hall_sens_i
...
#set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { hall_sens_i }]; #IO_0_35 Sch=hall_sens_i[0]
